...
## Unplayed units
- Blood Stalkers (unit size 5)
- High Gladiatrix (unit size 1)
- Krethusa the Croneseer (unit size 1)
- Slaughter Queen (unit size 1)
- SoG Bloodwrack Shrine (unit size 1)
...
## Assumptions
- Model counts default to 1 unless the list export includes an explicit model count or constants.py has a faction-specific inference.
- Alias normalization is only applied for entries listed in constants.py.
