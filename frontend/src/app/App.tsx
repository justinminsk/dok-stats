...
export function App() {
  ...
  if (state.status === 'loading') {
    return (
      <AppShell title="Daughters of Khaine Stats" subtitle="Play rates of winning lists">
        <StatusPanel
          detail="Loading the latest Daughters of Khaine list data and summary views."
  ...
  if (state.status === 'error') {
    return (
      <AppShell
        title="Daughters of Khaine Stats"
    ...
    <AppShell
      ...
      banner={
        state.source === 'sample'
          ...
          : 'Loaded Daughters of Khaine list data successfully.'
      }
    >
