...
from daughters_stats.constants import (
    DOCS_DIR,
    INPUT_FILE,
    REPORTS_DIR,
    ROOT,
...
def build_template(start_date: str) -> str:
    return (
        "# Daughters of Khaine post-points reset\n\n"
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Archive current stats outputs and reset source markdown for the next points cycle."
    )
    parser.add_argument(
        "--label",
