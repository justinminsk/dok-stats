...
THEME_TOKENS = {
    "dark": {
        "colorBg": "#0B080A",
        "colorBgElevated": "#161114",
        "colorBgMuted": "#110D0F",
        "colorBgInput": "#1A1418",
        "colorBgInputHover": "#241C22",
        "colorText": "#FDF4E1",
        "colorTextSoft": "#D2BEAB",
        "colorMuted": "#8C7A70",
        "colorAccent": "#8E0A0A",
        "colorAccentStrong": "#B81111",
        "colorAccentRgb": "142, 10, 10",
        "colorSurface": "#140E11",
        "colorBorder": "#3D2B33",
        "colorFocus": "#00736C",
        "colorOverlay": "rgba(11, 8, 10, .93)",
        "colorTeal": "#00736C",
        "colorMagenta": "#AF8B34",
    },
    "light": {
        ...
        "colorText": "#1A1A1A",
        "colorTextSoft": "#4F4F4F",
        "colorMuted": "#70625A",
        "colorAccent": "#C11B1B",
        "colorAccentStrong": "#911111",
        "colorAccentRgb": "193, 27, 27",
        "colorSurface": "#FFFFFF",
        "colorBorder": "#DDC8B5",
        "colorFocus": "#00A39C",
        "colorOverlay": "rgba(252, 249, 242, .95)",
        "colorTeal": "#00A39C",
        "colorMagenta": "#B7914A",
    },
}
...
def _stats_table_rows() -> int:
    raw_value = os.getenv("DAUGHTERS_STATS_TABLE_ROWS", str(STATS_TABLE_ROWS_DEFAULT))
    try:
